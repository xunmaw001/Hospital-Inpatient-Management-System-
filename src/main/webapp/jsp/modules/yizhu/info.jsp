                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>消费金额</label>
                                        <input id="zhuyuanfeiyongMoney" name="zhuyuanfeiyongMoney" class="form-control"
                                               v-model="ruleForm.zhuyuanfeiyongMoney" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.zhuyuanfeiyongContent != null && ruleForm.zhuyuanfeiyongContent != 'null' && ruleForm.zhuyuanfeiyongContent != '') {
            var zhuyuanfeiyongContentUeditor = UE.getEditor('zhuyuanfeiyongContentEditor');
                zhuyuanfeiyongContentUeditor.ready(function () {
                    ...
                    zhuyuanfeiyongContentUeditor.setDisabled('fullscreen');
            });
        }
    }
