    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">住院消费管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">住院消费列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">住院消费列表</h3>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="bingrenNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="消费病人名称" aria-controls="tableId">
                                    </div>
                                </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(bingrenNameCell);
            ...
            //消费原因
        var xiaofeijiluContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.xiaofeijiluContent && item.xiaofeijiluContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.xiaofeijiluContent.indexOf('<img');
            var endIndex = item.xiaofeijiluContent.indexOf('>');
                xiaofeijiluContentCell.innerHTML = item.xiaofeijiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.xiaofeijiluContent != null && item.xiaofeijiluContent != "" && item.xiaofeijiluContent.length >= 11) {
                    xiaofeijiluContentCell.innerHTML = item.xiaofeijiluContent.substring(0, 10) + "...";
            } else {
                    xiaofeijiluContentCell.innerHTML = item.xiaofeijiluContent;
            }
        }
        row.appendChild(xiaofeijiluContentCell);


        //消费金额
        var xiaofeijiluMoneyCell = document.createElement('td');
        xiaofeijiluMoneyCell.innerHTML = item.xiaofeijiluMoney;
        row.appendChild(xiaofeijiluMoneyCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("xiaofeijilu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addxiaofeijilu", "addxiaofeijilu");
        window.location.href = "add-or-update.jsp"
    }
