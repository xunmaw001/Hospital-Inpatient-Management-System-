            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">病人管理列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">病人管理列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    患病类型
                                    <div class="layui-input-inline">
                                        <select name="huanbingTypesSelectSearch"  style="width: 150px;" id="huanbingTypesSelectSearch" class="form-control form-control-sm"
                                                aria-controls="tableId">
                                        </select>
                                    </div>
                                </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //年龄
        var bingrenAgeCell = document.createElement('td');
        bingrenAgeCell.innerHTML = item.bingrenAge;
        row.appendChild(bingrenAgeCell);


        //家属联系方式
        var bingrenPhoneCell = document.createElement('td');
        bingrenPhoneCell.innerHTML = item.bingrenPhone;
        row.appendChild(bingrenPhoneCell);


        //患病类型
        var huanbingTypesCell = document.createElement('td');
        huanbingTypesCell.innerHTML = item.huanbingValue;
        row.appendChild(huanbingTypesCell);


            //患病详情
        var bingrenContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.bingrenContent && item.bingrenContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.bingrenContent.indexOf('<img');
            var endIndex = item.bingrenContent.indexOf('>');
                bingrenContentCell.innerHTML = item.bingrenContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.bingrenContent != null && item.bingrenContent != "" && item.bingrenContent.length >= 11) {
                    bingrenContentCell.innerHTML = item.bingrenContent.substring(0, 10) + "...";
            } else {
                    bingrenContentCell.innerHTML = item.bingrenContent;
            }
        }
        row.appendChild(bingrenContentCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("bingren/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addbingren", "addbingren");
        window.location.href = "add-or-update.jsp"
    }
