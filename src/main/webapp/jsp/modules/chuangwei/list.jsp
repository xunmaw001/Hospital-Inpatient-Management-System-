                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    床位状态
                                    <div class="layui-input-inline">
                                        <select name="chuangweiTypesSelectSearch"  style="width: 150px;" id="chuangweiTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //床位状态
        var chuangweiTypesCell = document.createElement('td');
        chuangweiTypesCell.innerHTML = item.chuangweiValue;
        row.appendChild(chuangweiTypesCell);
