                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yishengIdNumber" name="yishengIdNumber" class="form-control"
                                               onchange="yishengIdNumberChickValue(this)"  placeholder="身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>手机号</label>
                                        <input id="yishengPhone" name="yishengPhone" class="form-control"
                                               onchange="yishengPhoneChickValue(this)"  placeholder="手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>照片</label>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yishengName: "姓名不能为空",
                sexTypes: "性别不能为空",
                yishengIdNumber: "身份证号不能为空",
                yishengPhone: "手机号不能为空",
                yishengPhoto: "照片不能为空",
            }
        }).form();
    }
